...
>
  <View style={styles.filterContent}>
    ...
    />
      ...
      <Text style={styles.sectionTitle}>Fastjobs</Text>
        ...
        {offersData.map((offer) => (
          <TouchableOpacity key={offer.id} style={styles.recommendationCard} onPress={() => handleCardPress(offer)}>
            ...
            <TouchableOpacity onPress={() => toggleLike(offer.id)}>
                <View style={{backgroundColor:'#FF3A2F9E', width:55, borderRadius:5, alignContent:'center', alignItems:'center', }}>
                  <Text style={{color:'white', textAlign: 'center',}}>Fastjob</Text>
                </View>
              </TouchableOpacity>
