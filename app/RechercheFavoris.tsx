...
import Slider from "@react-native-community/slider"; // Ajoutez cette bibliothèque
import { Ionicons } from "@expo/vector-icons";
import Categories from "../components/Categories"; // Votre composant Categories
...
const RechercheFavoris = () => {
  const [selectedFavori, setSelectedFavori] = useState(null);
  const [modalVisible, setModalVisible] = useState(false);
  const [locationModalVisible, setLocationModalVisible] = useState(false); // Modal d'emplacement
...
export default RechercheFavoris;
